...
(function($){
    ...
    var autoplay, bgcolor, blocknum, blocktitle, border, core, container, content, dest, 
        ...
        startouch, vbheader, images, startY, startX, endY, endX, diff, diffX, diffY, threshold, close;
          ...
          var option = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.on('click', function(e){
                    ...
                    vbheader = '<div class="vbox-title"></div><div class="vbox-num">0/0</div>';
                    core = '<div class="vbox-overlay ' + extraCss + '" style="background:'+ overlayColor +'">'
                    + preloader + '<div class="vbox-container"><div class="vbox-content"></div><a href="#" class="vbox-close"><i class="icon-cancel"></i></a></div>' + vbheader + navigation + '</div>';
              ...
              */
              ...
              function updateOL(){
                  ...
                  var dieci = $(window).width()/10;
                  var novanta = dieci*9;
                  if (($(window).width() - (dieci)) > 1200){
                    right = ($(window).width() - 1200 ) / 2 - 15;
                  } else {
                    var right = $(window).width() - novanta - 7;
                  }
                  ...
                  close.css("top", margine +2).css("right", right +"px");
