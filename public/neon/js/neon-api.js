...
function show_sidebar_menu(with_animation)
{
	...
	jQuery('#form_impersonifica_hotel').fadeIn(1000);
	jQuery('#label_impersonifica_hotel').hide(500);
}
...
function hide_sidebar_menu(with_animation)
{
	...
	jQuery('#form_impersonifica_hotel').hide(500);
	jQuery('#label_impersonifica_hotel').slideToggle(500);
}
