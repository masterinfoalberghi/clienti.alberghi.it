...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		/* ------------------------------------ */
		// Modifiche INFOALBERGHI
		/* ------------------------------------ */
		
		$("button[type=submit], button.submit").not('.avoid-glyphicon').click(function (e) {
// 			e.preventDefault();
			var $me = $(this);
			$me.hide();
			$me.after('<span class="wating btn btn-defualt"><i class="glyphicon glyphicon-time"></i></span>');
			$("button").fadeOut();
		...
		if($.isFunction($.fn.daterangepicker))
		{
			...
			{
				var y1 = '' + moment().format('YYYY');
				var y2 = '' + moment().subtract(1, 'year').format('YYYY');
				var y3 = '' +  moment().subtract(2, 'year').format('YYYY');
				//var y4 = '' +  moment().subtract(7, 'year').format('YYYY');
				
				// Change the range as you desire
				var ranges = {
				   'Ultimi 7 giorni': [moment().subtract(6, 'days'), moment()],
				   'Ultimi 30 giorni': [moment().subtract(29, 'days'), moment()],
				   'Ultimi 60 giorni': [moment().subtract(59, 'days'), moment()]
				}
				ranges["Estate " + y1] = [moment(y1 + " 06 01","YYYY MM DD"), moment(y1 +" 08 30","YYYY MM DD")];
				ranges["Estate " + y2] = [moment(y2 + " 06 01","YYYY MM DD"), moment(y2 + " 08 30","YYYY MM DD")];
				//ranges["Estate " + y3] = [moment(y3 + " 06 01","YYYY MM DD"), moment(y3 + " 08 30","YYYY MM DD")];
				
				ranges["Anno " + y1] = [moment().startOf('year'), moment().endOf('year')];
				ranges["Anno " + y2] = [moment().subtract(1, 'year').startOf('year'), moment().subtract(1, 'year').endOf('year')];
				//ranges["Anno " + y3] = [moment().subtract(2, 'year').startOf('year'), moment().subtract(2, 'year').endOf('year')];
				//ranges["Anno " + y4] = [moment().subtract(7, 'year').startOf('year'), moment().subtract(7, 'year').endOf('year')];
	...
	//Correzioni per menu sempre in lingua
