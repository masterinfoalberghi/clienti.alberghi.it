...
class TranslateSchedaHotel extends Command
{
    /**
    ...
    public function __construct()
    {
        ...
        //////////////////////////////////////////////////////
        $this->static_translation['DESCRIPTION'] = 'LA DESCRIPTION';
        $this->static_translation['LOCATION'] = 'EMPLACEMENT';
        $this->static_translation['ROOMS'] = 'PIÈCES';
        $this->static_translation['SERVICES'] = 'PRESTATIONS DE SERVICE';
        $this->static_translation['FOOD'] = 'ALIMENTS';
        $this->static_translation['KIDS'] = 'ENFANTS';
        $this->static_translation['POOL'] = 'PISCINE';
        $this->static_translation['POOLS'] = 'PISCINES';
        $this->static_translation['WELLNESS'] = 'BIEN-ÊTRE';
        $this->static_translation['BEACH'] = 'PLAGE';
        $this->static_translation['CYCLE TOURISM'] = 'CYCLE TOURISME';
        $this->static_translation['APARTMENTS'] = 'APPARTEMENTS';
    ...
    public function handle()
      ...
      $target = $this->choice('in quale lingua vuoi traduure (fr, de| default fr)?', ['fr', 'de'], 0);
      ...
      foreach ($descrizioni_hotel as $descrizioni) 
          ...
          foreach ($descrizioni_json as $key => $desc) 
              ...
              $this->info('Applicato static translation a hotel ID = '.$descrizioni->hotel_id);
