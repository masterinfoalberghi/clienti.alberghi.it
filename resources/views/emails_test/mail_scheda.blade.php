...
@include("emails_test.includes.head-contact", ["id"=>$hotel_id, "nome"=>$hotel_name, "rating" => $rating, "localita" => $localita, "img" => $img])
	        				...
	        				<td align="left" valign="top">
	        					...
	        					<table style="width:100%; padding:15px;" border="0" cellspacing="0" cellpadding="0">
				        			...
				        			<tr >
				        				...
				        				<td align="left" valign="top" style="padding: 7px 0;  text-align:left; font-size: 16px; border-bottom:1px solid #ddd;">
				        					<b>{{$camera[3]}} Ad</b> + <b>{{count($camera[4])}} Ba</b> <span style="font-size:16px;">({{implode(",", $camera[4])}} anno)</span>
				        				</td>
				        			</tr>
