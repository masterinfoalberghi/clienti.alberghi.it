...
<head>
	...
	<style>
	    ...
	    @include('desktop.css.homepage',        ["versioncss" =>  env('VERSIONCSS', '10')])
        @include('desktop.css.header-hover',    ["versioncss" =>  env('VERSIONCSS', '10')])
		@include('desktop.css.homepage-hover',  ["versioncss" =>  env('VERSIONCSS', '10')])
...
<body class="desktop class-page-home">
