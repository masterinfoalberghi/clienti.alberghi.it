...
if (!is_null($bambino_gratis)) {
 ...
 // $snippet.= '<span class="info"><strong><a href="' . url(Utility::getLocaleUrl($locale).'hotel.php?id='.$id) . '#bimbi_gratis">';
  $snippet.= '<span class="info"><strong><a href="' . Utility::getUrlWithLang($locale,'/hotel.php?id='.$id) . '#bimbi_gratis">';
  $snippet.= ' BAMBINI GRATIS fino a ' . $bambino_gratis->_fino_a_anni() . ' ' . $bambino_gratis->_fino_a_mesi();
