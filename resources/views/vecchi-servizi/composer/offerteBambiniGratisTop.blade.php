	...
	@foreach ($offers as $offerteTopBambiniGratis)
		...
		@if (!is_null($offerteTopBambiniGratisLingua))
			...
			<article class="box-offers-article margin-bottom-6 top">
				...
				<header>
					<h4 class="box-offers-article-title">{{strtoupper(trans('hotel.gratis_fino_a'))}} {{strtoupper($offerteTopBambiniGratis->_fino_a_anni())}} {{strtoupper($offerteTopBambiniGratis->_fino_a_mesi())}}</h4>
				</header>
