						...
						<!--<![endif]-->
										...
										<table align="center" style="width: 100%; background:#ffffff;" bgcolor="#ffffff"  border="0" cellspacing="0" cellpadding="0">
											<tbody>
												...
												@php $count_hotel = 1; @endphp
												{{-- loop sugli hotel contattati --}}
												@foreach ($dati_mail_reply as $hotel_id => $element)

													@if ($count_hotel > 1)
														<tr>
															<td colspan="2" bgcolor="#222222" style="padding:7px 15px; font-family: 'Helvetica Neue', Helvetica,  Arial, sans-serif; font-size:16px;  background: #222222; text-align:left; color:#fff; border-bottom:1px solid #222222;">
																&nbsp;&nbsp;
															</td>
														</tr>
													@endif
													...
													<tr>
														<td colspan="2" style="font-family: 'Helvetica Neue', Helvetica,  Arial, sans-serif; padding:15px 15px 0; text-align: left; font-size:20px;  color:#222; " align="left">{{$element['hotel_name']}} <sup style="color:#F9AE58; font-size: 14px;">{{$element['hotel_rating']}}</sup><span style="font-size:14px">&nbsp;&middot;&nbsp;{{$element['hotel_loc']}}</span></td>
													</tr>
													<tr>
														<td colspan="2" align="left" style="font-family: 'Helvetica Neue', Helvetica,  Arial, sans-serif; text-align:left; padding:5px 15px 15px; font-size: 14px; ">
															<a href="https://www.info-alberghi.com/hotel.php?id={{$hotel_id}}">Vedi scheda {{$element['hotel_name']}}</a> <b style="font-size:18px">&rarr;</b>
														</td>
													</tr>
																	...
																	<tr>
																		<td align="left" valign="top" style="padding:15px">
																			...
																			<table style="width:100%;" border="0" cellspacing="0" cellpadding="0">
																				...
																				@endif
																				@if ( isset($room["caparra"][$hotel_id]) && count($room["caparra"][$hotel_id]) )
																							...
																							<table style="border-collapse: collapse; background: #ecf3e5;">
																								...
																								<tr>
																									<td colspan="2" align="left" valign="top" style="font-family: 'Helvetica Neue', Helvetica, 	 Arial, sans-serif; padding:7px; text-align:left; font-size: 13px; border-bottom: 1px solid #8CC152; border-left: 1px solid #8CC152; border-right: 1px solid #8CC152;">
																										@foreach ($room["caparra"][$hotel_id] as $key => $caparra)
																											{!!$caparra!!}
																											@if ($key+1 < count($room["caparra"][$hotel_id]))
																												<br/><br/>
																											@endif
																										@endforeach
																									</td>
												...
												@php $count_hotel++; @endphp
												@endforeach {{-- loop sugli hotel contattati --}}
												@if (count($dati_json["rooms"]) > 1)
													<tr>
														<td colspan="2">
															<!-- Richiesta -->
