		...
		<tr>
			<td style="line-height: 28px; padding:7px 15px 15px; font-size: 16px; font-family: 'Helvetica Neue', Helvetica,  Arial, sans-serif;">
				<p style="margin-top:0">
					Gentile {{$nome_cliente}},<br>ti informiamo che alcuni titoli della <b style="background: #FFF9C4; padding:2px 5px;">"galleria fotografica"</b> relativi alla struttura <b style="background: #FFF9C4; padding:2px 5px;">"{{$hotel_name}}"</b> sono <b style="background: #FFF9C4; padding:2px 5px;">stati moderati dallo staff di Info Alberghi</b>.
				</p>
