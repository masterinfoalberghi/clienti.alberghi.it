...
@section('content')
    ...
    <div class="legenda">
        ...
        <span class="legenda-item"><i class="glyphicon glyphicon-globe">&nbsp;</i> La pagina ha un template <b>località</b></span>
        <span class="legenda-item"><i class="glyphicon glyphicon-align-justify">&nbsp;</i> La pagina ha un template <b>listing</b></span>
        <span class="legenda-item"><i class="glyphicon glyphicon-map-marker">&nbsp;</i> La pagina ha un template <b>stradario</b></span><br />
    </div>
            ...
            <thead>
                <tr>
                    <th></th>
                        ...
                        echo Utility::viewThOrderBy('Template', 'template');
                ...
                <tr>
                    ...
                    <th width="70">
                        {!! Form::select('attiva',  ["1" => "", 1 => "si", 0 => "no"], $old['attiva'], ['class' => 'form-control']) !!}
                    </th >

                    <th width="100">
                        {!! Form::select('template',  ["" => "", "localita" => "Località", "listing" => "Listing", "stradario" => "Stradario"], $old['template'], ['class' => 'form-control']) !!}
                    </th>
                    <th>
            ...
            @foreach($data["records"] as $cms_pagina)
                ...
                <tr <?php echo $style ?> id="col_{{ $cms_pagina->id }}">
                    ...
                    <div class="modifica-inline-footer">
                        ...
                        @elseif($cms_pagina->template == "localita")
                        ...
                        <a style="color:#b20000; " target="blank" href="https://www.info-alberghi.com/{{$cms_pagina->uri}}">{{ $cms_pagina->uri }} <i class="entypo-popup"></i></a>
                    ...
                    <div class="modifica-inline-form form-horizontal form-group">
                        ...
                        {!! Form::open(["id" => "form-line-" .  $cms_pagina->id ,'url' => 'admin/listing/massive/edit', 'method' => 'POST']) !!}
                    ...
                    <td class="text-center">
                        <a href="{{ url("admin/listing/".$cms_pagina->id."/edit") }}" class="btn btn-primary modify-button">Modifica</a>
