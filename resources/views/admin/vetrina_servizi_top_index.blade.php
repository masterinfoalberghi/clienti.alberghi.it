  ...
  <div class="row">
    ...
    @if(isset($archiviate))
      <div class="alert alert-info">
        <i class="fa fa-info-circle"></i> Vetrine servizi "Top" <em>archiviata</em>.
      </div>
    @else
      <div class="alert alert-info">
        <i class="fa fa-info-circle"></i> Non hai ancora creato nessuna <em>Vetrine servizi "Top"</em>, <a href="{{ url("admin/vetrine-servizi-top/create") }}">creane una ora</a>.
      </div>
    @endif
    </div>
  </div>
@else
  <div class="row">
    <div class="col-lg-12">
      ...
      <h4>Elenco Vetrine servizi TOP @if(isset($archiviate))<b>ARCHIVIATE</b>@endif</h4>
        ...
        <thead>
          <tr>
            ...
            <th class="text-center" rowspan="4" valign="center">
              <a href="{{ url('admin/vetrine-servizi-top/'.$vetrina->id.'/edit')}}" class="btn btn-primary">Modifica</a>
            </th>
            <th class="text-center" rowspan="4" valign="center">
              
              @if (isset($archiviate))
                  {!! Form::open(['id' => 'archvia', 'url' => 'admin/vetrine-servizi-top/'.$vetrina->id.'/ripristina', 'method' => 'POST']) !!}
                    <button type="submit" class="btn btn-green">Pubblica</button>
                  {!! Form::close() !!}
                @else
                  {!! Form::open(['id' => 'archvia', 'url' => 'admin/vetrine-servizi-top/'.$vetrina->id.'/archivia', 'method' => 'POST']) !!}
