...
@section('title')
  <small>Inserisci una o più immagini alla gallery di:</small><br />{{$hotel->nome}}
@endsection
...
@section('onbodyclose')
  ...
  <script src="{{Utility::assets('/vendor/neon/js/dropzone/dropzone.js')}}"></script>
  ...
  <script type="text/javascript">
    ...
    var myDropzone = new Dropzone("div#dropzoneFileUpload", {
         url: baseUrl+"/admin/immagini-gallery/uploadImage",
