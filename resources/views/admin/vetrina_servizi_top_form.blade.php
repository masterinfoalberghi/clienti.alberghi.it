...
@section('title')
  @if (isset($vetrina))
    Modifica vetrina servizi "Top"
  @else
    Nuova vetrina servizi "Top"
  @endif
@endsection
...
<div class="row">
  <div class="col-lg-12">
    ...
    @if (isset($vetrina))
      {!! Form::open(['id' => 'record_delete', 'url' => 'admin/vetrine-servizi-top/'.$vetrina->id, 'method' => 'DELETE']) !!}
   ...
   @if (isset($vetrina))
      {!! Form::model($vetrina, ['role' => 'form', 'route'=>['vetrine-servizi-top.update',$vetrina->id], 'method' => 'PUT', 'class' => 'form-horizontal', 'id' => 'form_modifica_offerta','files' => true]) !!}
    ...
    @else
      {!! Form::open(['role' => 'form', 'route'=>['vetrine-servizi-top.store'], 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true]) !!}
    @endif
                    ...
                    <?php $vetrina_lingua = $vetrinaLingua[$lang]; ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-4">
                              ...
                              @else
                                {!! Form::select('pagina_id'.$lang, ['0' => '']+$pagine[$lang]->toArray(), $vetrina_lingua['pagina_id'], ["class"=>"form-control ipo"]) !!}
                              @endif  
