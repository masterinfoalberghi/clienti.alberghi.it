...
@section('icon')
	<i class="glyphicon glyphicon-phone" style="color:#ddd;"></i>&nbsp;&nbsp;
@endsection

@section('title')
    Telefonate all'Hotel
@endsection
...
@section('content')
	...
	@if($stats)
		<div class="row">
			...
			<div class="col-md-2">
				<div class="tile-stats tile-red stat-tile" style="height:auto; min-height:auto;"><h3>{{$super_totale}}</h3><p>Totale telefonate</p></div>
			</div>
