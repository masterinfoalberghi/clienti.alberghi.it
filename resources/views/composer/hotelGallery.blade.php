...
@if (!is_null($immagini_gallery) && count($immagini_gallery))
	...
	<section id="gallery" class="margin-bottom">
		...
		<nav class="slider-nav">
			...
			@foreach ($immagini_gallery as $thumb => $img)
				...
				<div class="thumbs @if($t == $current) current @endif " @if($t >= 20) style="display:none;" @endif>
			...
			@if (!is_null($cliente->descrizioneHotel) && $cliente->descrizioneHotel->video_url != '' )
				...
				<div class="thumbs t-video" @if($t >= 20) style="display:none;" @endif>
            ...
            @if($t >= 20) 
                <a onclick="showAllThumbs(this); return false;" href="#" style="padding:5px; ">mostra altro...</a>
            @endif
