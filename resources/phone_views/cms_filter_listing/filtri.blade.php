<div class="container filters">
	...
	<div class="row">
        ...
        <div class="col-xs-3 filter ordine">
			...
			<input id="order" name="order" type="hidden" value="0" />
		...
		<div class="order_select">
            ...
            @if($clienti->currentPage())
                @php $paging = "&page=" . $clienti->currentPage(); @endphp
            @endif

			<ul>
				<li><a href="?order=nome{{$paging}}" 			data-val="nome" 		 	>{{trans("listing.filtri_nome")}}</a></li>
				<li><a href="?order=categoria_asc{{$paging}}" 	data-val="categoria_asc" 	>{!!trans("listing.filtri_1_5")!!}</a></li>
				<li><a href="?order=categoria_desc{{$paging}}"  data-val="categoria_desc"	>{!!trans("listing.filtri_5_1")!!}</a></li>
				<li><a href="?order=prezzo_min{{$paging}}" 	    data-val="prezzo_min" 	 	>{{trans("listing.filtri_prezzo_min")}}</a></li>
			</ul>
		</div>
