...
<html lang="{{$locale}}">
  <head>
    ...
    <style>
		...
		@include('mobile.css.css-above.above-scheda-mobile-os')
	</style>
			...
			<div class="container">
					...
					<div class="row white-bg" style="padding-top:50px;">
						<div class="col-xs-12"  id="datihotel" style="text-align:center; ">
							...
							@include("share" , ["marginbottom"=>1, "text" => 'Ci sono delle *offerte speciali* per questo hotel a *'.$selezione_localita.'*'])
						</div>
					</div>
					
					@include('composer.offerte', array('titolo' => trans('hotel.offerte_generiche_box')))
