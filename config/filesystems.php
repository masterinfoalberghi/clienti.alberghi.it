	...
	*/
	...
	'disks' => [
		...
		'local' => [
			...
			'rating_upload'   => storage_path().'/app/rating/uploads',
		],
		...
		// definisco 2 nuovi dischi per la gallery ed il listing
		'gallery' => [
			'driver' => 'local',
		...
		'spothome' => [
			'driver' => 'local',
			'root'   => public_path().'/images/spothome',
		],
