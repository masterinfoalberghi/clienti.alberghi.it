 ...
 */
class CreateTblStatsVttArchiveLuglioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblStatsVttArchive_Luglio', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tblStatsVttArchive_Luglio');
    }
}
