 ...
 */
class CreateTblStatsVaatArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblStatsVaatArchive', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tblStatsVaatArchive');
    }
}
